...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 print:bg-white print:text-black">
      
      {/* Navbar / Control Bar */}
      <nav className="sticky top-0 z-40 w-full border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md print:hidden">
      ...
      {/* Main Content */}
      <main className="max-w-5xl mx-auto px-4 py-12 print:py-0 print:px-0 print:max-w-full">
        
        {/* Hero Header */}
        <header className="mb-16 print:mb-8 print:mt-8">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-1 space-y-4">
              
              <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white print:text-black print:text-4xl">
                {resumeData.basics.name}
              </h1>
              <p className="text-xl md:text-2xl text-blue-600 dark:text-blue-400 font-mono print:text-gray-700 print:text-lg">
                {`> ${resumeData.basics.label}_`}
              </p>
              <p className="max-w-2xl text-gray-600 dark:text-gray-400 leading-loose text-lg print:text-gray-800 print:text-sm">
                {resumeData.basics.summary}
              </p>
              
               <div className="flex items-center gap-4 text-gray-500 dark:text-gray-400 text-base font-mono mt-2 print:text-black print:gap-4 print:text-xs">
                 <span>📍 {resumeData.basics.location.city}, {resumeData.basics.location.region}</span>
                 <span className="print:block hidden">•</span>
                 <span className="print:block hidden">{resumeData.basics.email}</span>
                 <span className="print:block hidden">•</span>
                 <span className="print:block hidden">{resumeData.basics.url}</span>
               </div>
      ...
      {/* Footer */}
      <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 mt-20 print:hidden">
